...
@connect(({ common, answer, orgPopView, userPopView, orgSinglePopView }) => ({
    ...common,
    ...answer,
...
class Answer extends Component<AnswerProps, AnswerState> {
    ...
    // 下一步
    handleNextStep = e => {
        const { answerFormData, checkedOrgList, checkedUserList, checkedOrg } = this.state;
        ...
        validate.data(checkedOrg.id).isRequired('开始时间不能为空');
    ...
    render() {
        const { answerFormData, filePath, checkedUserList, checkedOrgList, checkedOrg, toast} = this.state;
        ...
        return (
            <View className='answer-create'>
                ...
                <View className='answer-create-form'>
                    <View className='at-row answer-create-form-item' onClick={this.handleChooseStartOrg.bind(this)}>
                        <View className='at-col at-col-5'>
                            <View>发起组织</View>
                        </View>
                        <View className='at-col at-col-6'>
                            <View className='answer-create-form-item-content'>{ checkedOrg.name ? checkedOrg.name : '请选择' }</View>
                        </View>
                        ...
                        <View className='at-col at-col-6'>
                            {
                                ...
                                : <View className='answer-create-form-item-content'>请选择</View>
                            }
                        </View>
                        <View className='at-col at-col-1'>
                            <AtIcon prefixClass='icon icon-youjiantou' value='chevron-right' size='12' color='#ccc'></AtIcon>
                    ...
                    <View className='at-row answer-create-form-item'>
                        ...
                        <View className='at-col at-col-7'>
                            <AtSwitch onChange={ this.onSwitchChange.bind(this) } color='#FF574F' checked={ answerFormData.peopleJoin == '1' } border={ false } />
                        </View>
                    </View>
