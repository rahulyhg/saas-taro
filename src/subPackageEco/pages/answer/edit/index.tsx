...
@connect(({ answer, activityOrg, activityUser }) => ({
    ...answer,
...
class Edit extends Component<EditProps,EditState > {
    ...
    initData = async () => {
        ...
        if (this.state.currentTab == 0) {
            ...
            console.log(this.props.answerResult)
        } else {
            await dispatch({
    ...
    render() {
        const { answerResult, checkedOrgList, checkedUserList } = this.props;
                        ...
                        <View style='margin-top:42px;background-color: #f5f5f5;'>
                            <View className='answer-result-head'>
                                <View className='answer-result-head-user'>
                                    <Dimage
                                        src={answerResult.createByCover}
                                        mode='aspectFit'
                                        type='avatar'
                                    ...
                                    return (
                                        <View className='answer-result-item'>
                                            <View className='answer-result-item-head'>
                                                <Text className='answer-result-item-head-type'>{ question.title == 0 ? '单选' : '多选' }</Text>
                            ...
                            <View className='answer-edit-form'>
                                ...
                                <View className='at-row answer-edit-form-item'>
                                    ...
                                    <View className='at-col at-col-6' onClick={this.chooseCover}>
                                        <Image
                                            src={ process.env.apiBackImgPre + answerFormData.cover }
                                            mode='aspectFit'
                                            onError={e => {
