...
class Edit extends Component<EditProps, EditState> {
    ...
    render() {
        ...
        const { surveyFormData, checkedOrgList, checkedUserList, redNeed, redTotalNum, redPayTotal } = this.state;
        const { surveyResult, checkedOrg } = this.props;
        const startTimeFormat = this.dateFormat(this.state.surveyFormData.startTime, 'yyyy年MM月dd日');
        const endTimeFormat = this.dateFormat(this.state.surveyFormData.endTime, 'yyyy年MM月dd日');
            ...
            <View className='survey-edit'>
                ...
                <AtTabs
                    ...
                    <AtTabsPane current={this.state.currentTab} index={0}>
                        <View style='margin-top:42px;background-color: #f5f5f5;'>
                    ...
                    <AtTabsPane current={this.state.currentTab} index={1}>
                        <View style='margin-top:42px;background: #f5f5f5;'>
                                ...
                                <View className='at-row survey-edit-form-item'>
                                    <View className='at-col at-col-5'>
                                        ...
                                        <View className='survey-edit-form-item-date'>
                                            <Picker mode="date" value={surveyFormData.startTime} onChange={this.onDateChange.bind(this, 'start')}>
                                    ...
                                    <View className='at-col at-col-5'>
                                        <View>结束时间</View>
                                        <View className='survey-edit-form-item-date'>
                                            <Picker mode="date" value={surveyFormData.endTime} onChange={this.onDateChange.bind(this, 'end')}>
                                                <View className="picker">
                                                    {endTimeFormat}
                                                </View>
                                            </Picker>
                            ...
                            <View className='survey-edit-form'>
                                ...
                                <View className='at-row survey-edit-form-item'>
                                    ...
                                    <View className='at-col at-col-7'>
                                        <View className='survey-edit-form-item-content' style='padding-right: 32rpx;'>是</View>
                                    </View>
                                </View>
                            ...
                            <View className='survey-edit-form'>
                                <View className='at-row survey-edit-form-item'>
                                    ...
                                    <View className='at-col at-col-7'>
                                        <AtSwitch border={false} value={redNeed == 1} onChange={this.redSwitchChage} />
                                    </View>
                                </View>
                                {
                                    redNeed && <Block>
