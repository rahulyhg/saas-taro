...
@connect(({ voteEdit, orgPopView, userPopView, activityOrg, activityUser, popView }) => ({
    ...voteEdit,
            ...
            callback: (res) => {
                ...
                if(res.code==1){
                    ...
                    dispatch({
                        ...
                        payload: {
                            oldCheckedOrgList: resFormData.orgDto,
                            checkedOrgList: resFormData.orgDto
                        }
                    })
                    // 更新 选择人员 页面的已选数据
                    dispatch({
                        ...
                        payload: {
                            oldCheckedUserList: resFormData.userDto,
                            checkedUserList: resFormData.userDto
                        }
                    })
            ...
            <View className='vote-edit'>
                ...
                <View className='vote-edit-form'>
                    ...
                    <View className='at-row vote-edit-form-item'>
                        ...
                        <View className='at-col at-col-7 textR' style='line-height: 64rpx;'>{peopleJoin == '1' ? '是':'否'}</View>
                    </View>
                    ...
                    <View className='at-row vote-edit-form-item'>
                        ...
                        <View className='at-col at-col-7 textR' style='line-height: 64rpx;'>{anonymous == '1' ? '是':'否'}</View>
                    </View>
                    ...
                    <View className='at-row vote-edit-form-item'>
                        ...
                        <View className='at-col at-col-7 textR' style='line-height: 64rpx;'>{repeatVote == '1'?'是':'否'}</View>
                    </View>
