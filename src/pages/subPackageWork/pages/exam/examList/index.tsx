...
import { IexamListProps, IexamListState } from './index.interface'
...
class ExamList extends Component<IexamListProps,IexamListState > {
    config:Config = {
        navigationBarTitleText: '考试'
    }
    constructor(props: IexamListProps) {
        super(props)
        this.state = {
