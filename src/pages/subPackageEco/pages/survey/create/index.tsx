...
@connect(({ survey, orgPopView, userPopView, orgSinglePopView }) => ({
    ...survey,
...
class CreateSurvey extends Component<IcreateSurveyProps, IcreateSurveyState> {
    ...
    handleNextStep = e => {
        ...
        if (this.state.checkedOrgList.length <= 0) {
            Taro.showToast({
                icon: 'none',
                title: '活动参与组织不能为空'
            })
        ...
        if (this.state.checkedUserList.length <= 0) {
            Taro.showToast({
                icon: 'none',
                title: '活动参与人员不能为空'
            })
                ...
                <View className='activity-create-form'>
                    ...
                    <View className='at-row activity-create-form-item' onClick={this.handleChooseStartOrg}>
                        ...
                        <View className='at-col at-col-6'>
                            <View className='activity-create-form-item-content'>{checkedOrg.name}</View>
                        </View>
                    ...
                    <View className='at-row activity-create-form-item' >
                        ...
                        <View className='at-col at-col-7'>
                            <AtSwitch onChange={this.onSwitchChange} checked={peopleJoin} border={false} />
                        </View>
                    </View>
